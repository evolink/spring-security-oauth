...
public class DefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, OAuthRequest request)
	...
	private OAuth2Authentication createRefreshedAuthentication(OAuth2Authentication authentication, Set<String> scope) {
		...
		if (scope != null && !scope.isEmpty()) {
			OAuthRequest clientAuth = authentication.getAuthorizationRequest();
	...
	public String getClientId(String tokenValue) {
		...
		OAuthRequest authorizationRequest = authentication.getAuthorizationRequest();
	 ...
	 */
	protected int getAccessTokenValiditySeconds(OAuthRequest authorizationRequest) {
	 ...
	 */
	protected int getRefreshTokenValiditySeconds(OAuthRequest authorizationRequest) {
		if (clientDetailsService != null) {
			ClientDetails client = clientDetailsService.loadClientByClientId(authorizationRequest.getClientId());
	 ...
	 */
	protected boolean isSupportRefreshToken(OAuthRequest authorizationRequest) {
		if (clientDetailsService != null) {
			ClientDetails client = clientDetailsService.loadClientByClientId(authorizationRequest.getClientId());

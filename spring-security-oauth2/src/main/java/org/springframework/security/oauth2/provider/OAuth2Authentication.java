...
public class OAuth2Authentication extends AbstractAuthenticationToken {
	...
	private final OAuthRequest clientAuthentication;
	 ...
	 */
	public OAuth2Authentication(OAuthRequest oAuthRequest, Authentication userAuthentication) {
		super(userAuthentication == null ? oAuthRequest.getAuthorities() : userAuthentication.getAuthorities());
		this.clientAuthentication = oAuthRequest;
